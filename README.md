...
1. forward port `80` on your router or firewall to the IP of your balena device
2. in the balenaCloud web dashboard add the required `CERTBOT_DOMAIN` environment variable as defined above
3. in the balenaCloud web dashboard observe the certbot container logs to see if certs were successfully generated
